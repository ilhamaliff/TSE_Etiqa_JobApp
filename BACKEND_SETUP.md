...
3. Click **New query**.
4. Copy the entire contents of [database/supabase_schema.sql](./database/supabase_schema.sql) and paste it into the editor.
...
2. Copy the contents of [database/seed_demo_data.sql](./database/seed_demo_data.sql) and paste it into the editor.
...
Ensure you have a [.env.local](.env.local) file in the root directory containing your project credentials:
